...
model.fit_generator(batches, GetSteps(batches), epochs=14, validation_data = test_batches, validation_steps = GetSteps(test_batches))

model.optimizer.lr=0.0001
model.fit_generator(batches, GetSteps(batches), epochs=10, validation_data = test_batches, validation_steps = GetSteps(test_batches))
